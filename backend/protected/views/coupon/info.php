...
$this->title = $model->title.'<small>发放列表</small>';
$this->pageTitle = '发放列表';
?>
    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>发放列表
                </div>
                <div class="actions">
                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('coupon/grant/id/'.$model->id)?>">
                        <i class="fa fa-plus"></i>
                        <span class="hidden-480">发放<?php echo $model->title;?> </span>
                    </a>
                </div>
            </div>
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("coupon/info/id/$model->id",array('isAjax'=>1))?>';
