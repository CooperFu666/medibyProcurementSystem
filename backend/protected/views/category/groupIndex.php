...
$this->breadcrumbs=array(
    ...
    array('name'=>'商品管理'),
    array('name' => '商品分类列表', 'url' => array('category/index')),
    array('name'=>'子分类管理')
);
$this->pageTitle = $model->title.'>子分类管理';
$this->title = $model->title.'<small>子分类管理</small>';
?>
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i><?php echo $model->title;?>>子分类管理
                </div>
                <div class="actions">
                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('category/addGroup/id/'.$id)?>">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("category/groupIndex/id/".$id, array('isAjax'=>1))?>';
