...
$this->pageTitle = '商品主分类管理';
$this->title = '主分类管理<small>商品分类管理</small>';
?>
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>商品主分类管理
                </div>
                <div class="actions">

                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('category/add')?>">
                        <i class="fa fa-plus"></i>
                        <span class="hidden-480">商品主分类添加 </span>
                    </a>
                </div>
            </div>
