    ...
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>开始审核
                </div>
            </div>
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="datatable_list">
                        <tbody>
                            ...
                            <tr>
                                <td>修改价格：</td>
                                <td><input placeholder="不填默认为券后价格" name="alter_price"></td>
                            </tr>
                        </tbody>
                    </table>
                        <input name="orderId" value="<?php echo $_GET['order_id']; ?>" hidden>
                        <label style="color: green; font-weight: bold"><input type="radio" name="check" value="true" checked>审核通过</label>
                        <label style="color: red; font-weight: bold"><input type="radio" name="check" value="false">审核不通过</label>
