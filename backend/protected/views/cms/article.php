...
$this->pageTitle = '文章管理';
$this->title = '文章列表<small>文章管理</small>';
?>
<!-- BEGIN PAGE CONTENT-->
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet">
            <div class="portlet-title form-horizontal">
                <div class="caption">
                    <i class="fa fa-paper-plane"></i>文章列表
                </div>
                <div class="actions">

                    <a class="btn default yellow-stripe" href="<?php echo Yii::app()->createUrl('cms/articleAdd')?>">
...
<script>
    jQuery(document).ready(function() {
        var url = '<?php echo $this->createUrl("article",array('isAjax'=>1))?>';
